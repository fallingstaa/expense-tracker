...
export default function Header() {
  return (
    <Disclosure
      as="nav"
      className="fixed top-0 left-0 right-0 z-50 bg-gray-800 after:pointer-events-none after:absolute after:inset-x-0
       after:bottom-0 after:h-px after:bg-white/10"
    >
        ...
        <div className="relative flex h-16 items-center justify-between">
          <div className="absolute inset-y-0 left-0 flex items-center sm:hidden">
            <DisclosureButton
             ...
             text-gray-400 hover:bg-white/5 hover:text-white focus:outline-2 focus:-outline-offset-1 focus:outline-indigo-500"
            >
          ...
          <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
            <div className="flex gap-2 shrink-0 items-center">
              <img alt="Your Company" src={bg1} className="h-17 w-17" />
